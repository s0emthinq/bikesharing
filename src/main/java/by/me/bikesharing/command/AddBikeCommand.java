...
//
//            if (BikeValidator.isParametersValid(latitudeAsString, longitudeAsString,
//                    costPerHourAsString, statusAsString, organisationIdAsString)) {
...
//                long idOrganisation = Long.parseLong(request.getParameter(PARAM_NAME_ID_ORGANISATION));
//
//                try {
//                    Bike bike = new Bike(latitude, longitude, costPerHour, status, idOrganisation);
...
//
//            } else {
//                message = "Some of the parameters are invalid.";
//            }
//        } else {
//            message = "Fill in all the parameters.";
//        }
