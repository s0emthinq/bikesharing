...
<table border="1" align="center">
    ...
    <c:forEach var="bike" items="${bikesList}" varStatus="loop">
        ...
        <tr>
            ...
            <td>
                <a href="http://localhost:8080/controller?command=forward_to_update_bike&id=${bike.id}&oldLatitude=${bike.latitude}&oldLongitude=${bike.longitude}&oldCostPerHour=${bike.costPerHour}&oldStatus=${bike.status}&oldIdOrganisation=${bike.idOrganisation}">
                        ${update}
                </a>
                <a href="http://localhost:8080/controller?command=delete_bike&id=${bike.id}">
                        ${delete}
                </a>
            </td>
        </tr>
...
<div align="center">
    <a href="controller?command=forward_to_add_bike">
        +${addBike}
    </a> <br/>
